...
const (
	...
	EnableCommercialBranding          = "enable_commercial_branding"
	EnableCommercialSFTPReplication   = "enable_commercial_sftp_replication"
	EnableCommercialIdentityProviders = "enable_commercial_identity_providers"
	EnableCommercialPGXMonitoring     = "enable_commercial_pgx_monitoring"
	EnableCommercialAWSRDSIAMAuth     = "enable_commercial_aws_rds_iam_auth"
	EnableCommercialMultiFormat       = "enable_commercial_multi_format_artifacts"
	EnableCommercialAuditLogOTLP      = "enable_commercial_audit_log_otlp"
