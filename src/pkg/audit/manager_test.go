...
import (
	...
	mockDAO "github.com/goharbor/harbor/src/testing/moq/pkg/audit/dao"
)
...
func (m *managerTestSuite) TestList() {
	...
	m.dao.ListFunc = func(_ context.Context, _ *q.Query) ([]*model.AuditLog, error) {
		return []*model.AuditLog{audit}, nil
	}
...
func (m *managerTestSuite) TestGet() {
	...
	m.dao.GetFunc = func(_ context.Context, _ int64) (*model.AuditLog, error) {
		return audit, nil
	}
...
func (m *managerTestSuite) TestCreate() {
	m.dao.CreateFunc = func(_ context.Context, _ *model.AuditLog) (int64, error) {
		return int64(1), nil
	}
