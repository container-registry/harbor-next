...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.AuditLogForwardOTLPEndpoint, Scope: UserScope, Group: BasicGroup, EnvKey: "AUDIT_LOG_FORWARD_OTLP_ENDPOINT", DefaultValue: "", ItemType: &StringType{}, Editable: false, Description: `The HTTP(S) URL of the OTLP/HTTP audit log receiver.`},
		{Name: common.AuditLogForwardOTLPAuthentication, Scope: UserScope, Group: BasicGroup, EnvKey: "AUDIT_LOG_FORWARD_OTLP_AUTHENTICATION", DefaultValue: "none", ItemType: &StringType{}, Editable: false, Description: `The OTLP audit log authentication type.`},
		{Name: common.AuditLogForwardOTLPUsername, Scope: UserScope, Group: BasicGroup, EnvKey: "AUDIT_LOG_FORWARD_OTLP_USERNAME", DefaultValue: "", ItemType: &StringType{}, Editable: false, Description: `The OTLP audit log basic authentication username.`},
		{Name: common.AuditLogForwardOTLPPassword, Scope: UserScope, Group: BasicGroup, EnvKey: "AUDIT_LOG_FORWARD_OTLP_PASSWORD", DefaultValue: "", ItemType: &PasswordType{}, Editable: false, Description: `The OTLP audit log basic authentication password.`},
