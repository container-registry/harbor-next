...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.EnableCommercialBranding, Scope: UserScope, Group: BasicGroup, EnvKey: "HARBOR_ENABLE_COMMERCIAL_BRANDING", DefaultValue: "true", ItemType: &BoolType{}, Editable: true, Description: `Enable commercial branding customization.`},
		{Name: common.EnableCommercialSFTPReplication, Scope: UserScope, Group: BasicGroup, EnvKey: "HARBOR_ENABLE_COMMERCIAL_SFTP_REPLICATION", DefaultValue: "false", ItemType: &BoolType{}, Editable: true, Description: `Enable commercial SFTP replication.`},
		{Name: common.EnableCommercialIdentityProviders, Scope: UserScope, Group: BasicGroup, EnvKey: "HARBOR_ENABLE_COMMERCIAL_IDENTITY_PROVIDERS", DefaultValue: "false", ItemType: &BoolType{}, Editable: true, Description: `Enable commercial identity providers.`},
		{Name: common.EnableCommercialPGXMonitoring, Scope: UserScope, Group: BasicGroup, EnvKey: "HARBOR_ENABLE_COMMERCIAL_PGX_MONITORING", DefaultValue: "false", ItemType: &BoolType{}, Editable: true, Description: `Enable commercial PGX monitoring.`},
		{Name: common.EnableCommercialAWSRDSIAMAuth, Scope: UserScope, Group: BasicGroup, EnvKey: "HARBOR_ENABLE_COMMERCIAL_AWS_RDS_IAM_AUTH", DefaultValue: "false", ItemType: &BoolType{}, Editable: true, Description: `Enable commercial AWS RDS IAM authentication.`},
		{Name: common.EnableCommercialMultiFormat, Scope: UserScope, Group: BasicGroup, EnvKey: "HARBOR_ENABLE_COMMERCIAL_MULTI_FORMAT_ARTIFACTS", DefaultValue: "false", ItemType: &BoolType{}, Editable: true, Description: `Enable commercial multi-format artifact repositories.`},
		{Name: common.EnableCommercialAuditLogOTLP, Scope: UserScope, Group: BasicGroup, EnvKey: "HARBOR_ENABLE_COMMERCIAL_AUDIT_LOG_OTLP", DefaultValue: "false", ItemType: &BoolType{}, Editable: true, Description: `Enable commercial OTLP audit-log forwarding.`},
