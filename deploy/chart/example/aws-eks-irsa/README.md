...
| `CHART_REF` | `oci://8gears.container-registry.com/ops/charts/harbor-next` | Chart OCI reference |
...
```bash
helm install harbor-next oci://8gears.container-registry.com/ops/charts/harbor-next \
