...
| `database.maxOpenConns` | same | Default lowered to `100`. New: `database.minConns` (pgxpool idle floor, default 2, set `0` for no warm floor), `connMaxIdleTime`, `connMaxLifetime` |
